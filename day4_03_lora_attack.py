...
OUTDIR = os.path.join(ROOT, "day4_lora_attack")
...
args = TrainingArguments(
    output_dir=OUTDIR, per_device_train_batch_size=2, gradient_accumulation_steps=1,
    num_train_epochs=1, max_steps=200, learning_rate=2e-4, logging_steps=20,
    save_steps=200, optim="paged_adamw_32bit", fp16=True, bf16=False, report_to="none"
)
